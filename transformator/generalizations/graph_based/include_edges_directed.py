...
def include_edges_directed(
    ...
    """Encodes the edges of a directed graph into the input qubo matrix (in
    place) in order to generalize graph based problem transformations
        ...
        for position in range(positions):
            ...
            if score_non_edges:
                ...
                unconnected_nodes = [
                    ...
                    if node not in connected_nodes and node != node1
                ]
                ...
                for node2 in unconnected_nodes:
                    if positions > 1:
                        ...
                        elif position == positions - 1 and score_non_edges_cycles:
